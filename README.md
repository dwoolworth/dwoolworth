...
**[Keycloak MCP Server](https://github.com/MnemoShare/mnemoshare-keycloak-mcp)** — A comprehensive MCP server for Keycloak administration with 134 tools across 13 domains. Lets AI assistants handle the tedious work of managing realms, clients, users, groups, and identity providers.

**[encyml](https://github.com/dwoolworth/encyml)** — A Go CLI tool for encoding YAML secret values for use with SOPS and Age encryption. Simplifies secrets management in GitOps workflows.
